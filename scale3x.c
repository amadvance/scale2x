	...
	for(y=0;y<dy;++y) {
		for(x=0;x<dx;++x) {
			...
			*/
			...
			put(x*3,y*3,dst,dx*3,dy*3,dp,E0);
			put(x*3+1,y*3,dst,dx*3,dy*3,dp,E1);
			put(x*3+2,y*3,dst,dx*3,dy*3,dp,E2);
			put(x*3,y*3+1,dst,dx*3,dy*3,dp,E3);
			put(x*3+1,y*3+1,dst,dx*3,dy*3,dp,E4);
			put(x*3+2,y*3+1,dst,dx*3,dy*3,dp,E5);
			put(x*3,y*3+2,dst,dx*3,dy*3,dp,E6);
			put(x*3+1,y*3+2,dst,dx*3,dy*3,dp,E7);
			put(x*3+2,y*3+2,dst,dx*3,dy*3,dp,E8);
		}
	}
}
